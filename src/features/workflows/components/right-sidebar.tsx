...
function Palette() {
  ...
  return (
    <Section title="Toolbar">
      <Accordion type="multiple" defaultValue={sections.map(s => s.kind)} className="px-3 py-2">
        {sections.map(section => (
          <AccordionItem key={section.kind} value={section.kind} className="not-last:border-b-0">
